...
int main() {
    ...
    try {
        ...
        std::cout << "✅ AW channel created with " 
                  << bundle_field_count_v<axi_lite_aw_channel<32>> << " fields" << std::endl;
        std::cout << "✅ W channel created with " 
                  << bundle_field_count_v<axi_lite_w_channel<32>> << " fields" << std::endl;
        std::cout << "✅ B channel created with " 
                  << bundle_field_count_v<axi_lite_b_channel> << " fields" << std::endl;
        std::cout << "✅ AR channel created with " 
                  << bundle_field_count_v<axi_lite_ar_channel<32>> << " fields" << std::endl;
        std::cout << "✅ R channel created with " 
                  << bundle_field_count_v<axi_lite_r_channel<32>> << " fields" << std::endl;
        ...
        std::cout << "✅ Write interface created with " 
                  << bundle_field_count_v<axi_lite_write_interface<32, 32>> << " fields" << std::endl;
        std::cout << "✅ Read interface created with " 
                  << bundle_field_count_v<axi_lite_read_interface<32, 32>> << " fields" << std::endl;
        std::cout << "✅ Full AXI-Lite created with " 
                  << bundle_field_count_v<axi_lite_bundle<32, 32>> << " fields" << std::endl;
        
        // 3. 协议验证演示
        std::cout << "3. Protocol Validation..." << std::endl;
        std::cout << "   Full AXI-Lite is AXI-Lite protocol: " 
                  << (is_axi_lite_v<axi_lite_bundle<32, 32>> ? "✅" : "❌") << std::endl;
        std::cout << "   Write interface is AXI-Lite write protocol: " 
                  << (is_axi_lite_write_v<axi_lite_write_interface<32, 32>> ? "✅" : "❌") << std::endl;
        std::cout << "   Read interface is AXI-Lite read protocol: " 
                  << (is_axi_lite_read_v<axi_lite_read_interface<32, 32>> ? "✅" : "❌") << std::endl;
        std::cout << "   Stream bundle is AXI-Lite protocol: " 
                  << (is_axi_lite_v<stream_bundle<ch_uint<32>>> ? "❌" : "✅") << std::endl;
        
        // 4. 字段检查演示
        std::cout << "4. Field Name Checking..." << std::endl;
        std::cout << "   Full AXI has 'aw' field: " 
                  << (has_field_named_v<axi_lite_bundle<32, 32>, structural_string{"aw"}> ? "✅" : "❌") << std::endl;
        std::cout << "   Full AXI has 'w' field: " 
                  << (has_field_named_v<axi_lite_bundle<32, 32>, structural_string{"w"}> ? "✅" : "❌") << std::endl;
        std::cout << "   Full AXI has 'b' field: " 
                  << (has_field_named_v<axi_lite_bundle<32, 32>, structural_string{"b"}> ? "✅" : "❌") << std::endl;
        std::cout << "   Full AXI has 'ar' field: " 
                  << (has_field_named_v<axi_lite_bundle<32, 32>, structural_string{"ar"}> ? "✅" : "❌") << std::endl;
        std::cout << "   Full AXI has 'r' field: " 
                  << (has_field_named_v<axi_lite_bundle<32, 32>, structural_string{"r"}> ? "✅" : "❌") << std::endl;
        ...
        std::cout << "\n🎉 All AXI-Lite Bundle features work correctly!" << std::endl;
