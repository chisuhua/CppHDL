 ...
 */
template <unsigned N>
ch_uint<N> and_gate(ch_uint<N> a, ch_uint<N> b) {
    return a & b;
}
 ...
 */
template <unsigned N>
ch_uint<N> or_gate(ch_uint<N> a, ch_uint<N> b) {
    return a | b;
}
 ...
 */
template <unsigned N>
ch_uint<N> not_gate(ch_uint<N> a) {
    return ~a;
}
 ...
 */
template <unsigned N>
ch_uint<N> xor_gate(ch_uint<N> a, ch_uint<N> b) {
    return a ^ b;
}
 ...
 */
template <unsigned N>
ch_uint<N> nand_gate(ch_uint<N> a, ch_uint<N> b) {
    return ~(a & b);
}
 ...
 */
template <unsigned N>
ch_uint<N> nor_gate(ch_uint<N> a, ch_uint<N> b) {
    return ~(a | b);
}
 ...
 */
template <unsigned N>
ch_uint<N> xnor_gate(ch_uint<N> a, ch_uint<N> b) {
    return ~(a ^ b);
}
...
ch_uint<N> mux(std::array<ch_uint<N>, M> inputs, ch_uint<compute_bit_width(M-1)> sel) {
 ...
 */
template <unsigned N>
ch_uint<N> mux4(ch_uint<N> in0, ch_uint<N> in1, ch_uint<N> in2, ch_uint<N> in3, ch_uint<2> sel) {
 ...
 */
template <unsigned N, unsigned M>
std::array<ch_uint<N>, M> demux(ch_uint<N> input, ch_uint<compute_bit_width(M-1)> sel) {
 ...
 */
template <unsigned N>
ch_bool parity_gen(ch_uint<N> input) {
 ...
 */
template <unsigned N>
ch_uint<N> buffer(ch_uint<N> input) {
    return input;
}
