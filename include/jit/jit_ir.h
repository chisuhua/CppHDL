...
inline JitInstr make_binary(JitOp op, VRegId dst, VRegId src0, VRegId src1, BitWidth bw) {
    JitInstr i(op, bw);
    i.dst = dst;
    i.src0 = src0;
    i.src1 = src1;
...
inline JitInstr make_select(VRegId dst, VRegId cond, VRegId src0, VRegId src1, BitWidth bw) {
